...
public class Opcje extends JFrame implements ActionListener {
	...
	protected static Plansza parent;
	...
	public Opcje(Plansza plansza) {
		...
		biciaWstecz = new JRadioButton("BICIA WSTECZ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == style) {
			...
			if (s == "Domyślny") {
				((RootPaneContainer) parent).getContentPane().setBackground(null);
				parent.repaint();
			}
			if (s == "Metal") {
				((RootPaneContainer) parent).getContentPane().setBackground(new Color(230, 230, 254));
				parent.repaint();
			}
			if (s == "Motif") {
				((RootPaneContainer) parent).getContentPane().setBackground(new Color(219, 247, 151));
				parent.repaint();
			}
			if (s == "Nimbus") {
				((RootPaneContainer) parent).getContentPane().setBackground(new Color(254, 254, 142));
				parent.repaint();
			}
		}
	}
